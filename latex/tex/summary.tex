...
Similar ideas based on subject lighting can be employed in both fields; this thesis still barely touched the confluence of the two, and further study on state-of-the-art is suggested to better dive into the subject.
...
The rig is to be used for digitizing real-life objects in higher resolution than what has been previously possible, and studying the process, helping to understand how different algorithms behave on different inputs.

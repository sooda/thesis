...
%For a higher frame rate, also a faster shutter speed is typically required.
...
For motion computation based on frame differences, a long enough time should be passed for reliable motion direction, though.

Fast shutter (i.e.~short exposure) needs to be compensated by using more sensitive sensors or brighter light sources to get equivalently bright images.

Film cameras and some professional video cameras use a rotary disc shutter that has an opaque 180 degree sector.
This is why the common practice of having half the exposure time of frame rate is sometimes called ``180 degree shutter''.

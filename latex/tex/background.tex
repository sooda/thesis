...
\includegraphics[width=0.2\textwidth]{roll4000}
	...
	The ruler does not bend and is vertical at all times, but appears skewed.
...
{ \color{gray}
\paragraph{random stuff to be moved}
...
(Should some of the main terms be defined in the beginning of the whole main section or the whole thesis? Probably...)

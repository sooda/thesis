...
Kind of the same thing as registration?
...
\subsubsection{Interpolation / Morphing}
...
Some techiques \cite{faceshift,something} use pre-recorded facial expressions to identify the subject's pose.
...
google up on bones and stuff

\subsection{Preprocessing}

Now that the reconstruction pipeline theory is covered, some practical hints on data usage before supplying it to the pipeline are presented.

Or should this be before most of the information above?

...
Depth of field is important to consider in near-field 3D scans, which practically means that a small aperture should be used.
It is important to note that the subject should fill whole image frame to use the pixel density effectively.
Increasing the distance to the subject would increase depth of field, but to enlarge the subject would need a longer lens, which decreases depth of field.
...
\simplegfx{h!}{\textwidth}{dofcoc}{
	Exaggerated illustration of circle of confusion and depth of field with a thin lens, seen from the side (not drawn to scale).

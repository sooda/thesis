...
% not. describe "in computer graphics, surfaces are shaded, not points"
%{ \color{red} (Should some of the main terms be defined in the beginning of the whole main section or the whole thesis? Probably...) }

...
\begin{itemize}
	\item Ease of use: the user should not need to know the implementation details (hardware internals or algorithms) or to have programming skills to calibrate the system and acquire a 3D scan
...
\simplegfx{h!}{0.8\textwidth}{flashbounce}{
...
The code also monitors a the Nucleo's integrated general-purpose pushbutton that can be used to focus and trigger all cameras simultaneously.

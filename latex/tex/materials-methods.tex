...
\begin{description}
	\item[Camera Calibration Toolbox for Matlab,] \cite{camcalmatlab} also included built-in in OpenCV, is a more or less standard tool for single-camera and stereo camera calibration.

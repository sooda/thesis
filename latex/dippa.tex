...
% multi-view stereo image acquisition rig for face reconstruction
\thesistitle{Thesis}{Dippa}

\place{Espoo}
\date{X.Y.2014}

\supervisor{D.Sc.\ (Tech.) Ville Kyrki}{Prof.\ Ville Kyrki}
\instructor{D.Sc.\ (Tech.) Jaakko Lehtinen}{Prof.\ Jaakko Lehtinen}

...
\newcommand*{\scene}[3]{
	...
	\node [fill=red,inner sep=1pt,label=90:$Z_2$] at (intersection-1) {} coordinate (Za);
	\draw [thin] (intersection-1) -- ++(\guideline, 0) coordinate (Zaa);

	\path [name intersections={of=ARl and ALr}];
	\node [fill=red,inner sep=1pt,label=-90:$Z_1$] at (intersection-1) {} coordinate (Zb);
	...
	\node [fill=red,inner sep=1pt,label=-100:$P_l$,left] at (uuh-1) {};
	\node [fill=red,inner sep=1pt,label=-80:$P_r$,right,right] at (aah-1) {};
	...
	\node [fill=red,inner sep=1pt,label=-100:$P_l$] at (uuh-1) {};
	\node [fill=red,inner sep=1pt,label=-80:$P_r$] at (aah-1) {};
	\draw [ultra thick] (uuh-1) -- (aah-1);
...
%\path [name intersections={of=AB and CD,total=\t}];
%    \foreach \s in {1,...,\t}{(intersection-\s) circle (2pt) node {\footnotesize\s}};
%\node [fill=red,inner sep=1pt,label=-90:$E$] at (intersection-1) {};
%\draw (intersection-1) --(0, 0);
